...
def main():
    ...
    while(i<10):
        ...
        path = '/home/Download/photo/'+contents[i][0][0]
        mkdir(path)#建立相应文件夹
    ...
    for imageUrl in imagesUrl:#将封面图片存入对应文件夹中
        ...
        html = urlopen(url)
        data = html.read()
        fileName = '/home/Download/photo/mm'+str(number)+'.jpg'
...
def getperMMpageImg(MMURL,MMpath):
    ...
    owndriver = webdriver.PhantomJS(executable_path='/opt/phantomjs/phantomjs')
    owndriver.get(MMURL)
    print("[*]Opening.....MM....................")
